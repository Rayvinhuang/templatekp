                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form method="POST" action="{{ route('register.store')}}" class="user" >
                                ...
                                <hr>
                                <a href="{{ route('register.index')}}" class="btn btn-google btn-user btn-block">
                                    <i class="fab fa-google fa-fw"></i> Register with Google
                                </a>
                                <a href="{{ route('register.index')}}" class="btn btn-facebook btn-user btn-block">
                                    <i class="fab fa-facebook-f fa-fw"></i> Register with Facebook
                                </a>
                            </form>
                            <hr>
                            <div class="text-center">
                                <a class="small" href="{{ route('register.index')}}">Forgot Password?</a>
                            </div>
                            <div class="text-center">
